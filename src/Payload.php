...
use Youbuwei\HyperfJwt\Exceptions\PayloadException;
...
class Payload implements \ArrayAccess, Arrayable, \Countable, Jsonable, \JsonSerializable
{
     ...
     *
     * @var \Youbuwei\HyperfJwt\Claims\Collection
     */
    private $claims;

    /**
     * @var \Youbuwei\HyperfJwt\Contracts\PayloadValidatorInterface
     */
    private $validator;
     ...
     * @param mixed $value
     *
     * @throws \Youbuwei\HyperfJwt\Exceptions\PayloadException
     */
